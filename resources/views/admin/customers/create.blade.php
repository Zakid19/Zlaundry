                ...
                <form action="{{ route('customer.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="no_tlp" name="no_tlp" value="{{ old('no_tlp') }}">
                        </div>
                        @error('no_tlp')
                            <div>
                                <div class="mt-2 mb-3 text-xs text-danger">{{ $message }}!</div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="jenis_kelamin" name="jenis_kelamin" value="{{ old('jenis_kelamin') }}">
                        </div>
                        @error('jenis_kelamin')
                            <div>
                                <div class="mt-2 mb-3 text-xs text-danger">{{ $message }}!</div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" id="alamat" name="alamat" value="{{ old('alamat') }}"> </textarea>
                            @error('alamat')
                                <div class="mt-2 mb-3 text-xs text-danger">{{ $message }}!</div>
                            @enderror
                        </div>
