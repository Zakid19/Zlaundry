                ...
                <form action="{{ route('paket.store',) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="nama_paket" name="nama_paket" value="{{ old('nama_paket') }}">
                            @error('nama_paket')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="harga" name="harga" value="{{ old('harga') }}">
                        </div>
                        @error('harga')
                            <div>
                                <div class="mt-2 mb-3 text-xs text-danger">{{ $message }}!</div>
